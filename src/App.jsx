...
function App() {
  ...
  const [updateAddToCart, setUpdateAddToCart] = useState(false);
  ...
  return (
    ...
    <div className='contain h-screen flex flex-col  items-center gap-8'>
      ...
      <Header number={addToCart || updateAddToCart ? count : ''} showModalProduct={addToCart} />
      <div className='main flex flex-row px-40 py-16 gap-28'>
        ...
        <div className="imgProduct w-1/2 flex flex-col gap-8 max-w-[25rem]">
          <div className='imgFull cursor-pointer'>
            ...
            <img id='imgFull' className=" rounded-[20px] " src={selectImage} alt="" />
          </div>
          <div className='imgList flex flex-row gap-2 pb-8'>
            <div onClick={
              ...
              <img className={`rounded-lg ${selectProductAmg === 1 ? ' border-orange-600 border-4 opacity-40 ' : ''} `} src={images[0]} alt="" />
            </div>
            <div onClick={
              () => {
              ...
              <img className={`rounded-lg  ${selectProductAmg === 2 ? ' border-orange-600 border-4 opacity-40 ' : ''} `} src={images[1]} alt="" />
            </div>
            <div onClick={
              () => {
              ...
              <img className={`rounded-lg ${selectProductAmg === 3 ? ' border-orange-600 border-4 opacity-40' : ''}`} src={images[2]} alt="" />
            </div>
            <div onClick={
              () => {
              ...
              <img className={`rounded-lg ${selectProductAmg === 4 ? ' border-orange-600 border-4 opacity-40 ' : ''}`} src={images[3]} alt="" />
            </div>
          </div>
        </div>
            ...
            <div className='addNumber whitespace-nowrap flex w-4/12 items-center justify-around px-6 py-3 rounded-lg bg-gray-100'>
              <button>
                <img onClick={() => {
                  ...
                  src="src/image/icon-minus.svg" alt="icon-minus" />
              </button>
              ...
              <button>
                <img onClick={() => {
                  ...
                  src="src/image/icon-plus.svg" alt="icon-plus" />
              </button>
            </div>
            <button onClick={() => {
              if (count !== 0) {
